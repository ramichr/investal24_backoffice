              ...
              <div class="card-body">
                <div class="table-responsive">
                  <div class="d-flex mb-3">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary text-nowrap"><i
                        class="fa fa-file-text scale5 mr-3" aria-hidden="true"></i>Generate Report</a>
                  </div>
                        ...
                        <td class="py-2 text-right">
                          <div class="dropdown"><button class="btn btn-primary tp-btn-light sharp" type="button"
                            ...
                            <div class="dropdown-menu dropdown-menu-right border py-0">
                              <div class="py-2"><a class="dropdown-item" href="kunde-profil.php">Profil Sehen</a><a
                                  class="dropdown-item text-danger" href="#!">Löschen</a></div>
                            </div>
                          </div>
                        </td>
                      </tr>
