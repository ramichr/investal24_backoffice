                            ...
                            <div class="card-body">
                                <div class="profile-statistics mb-5">
                                    <div class="text-center">
                                        <div class="row">
                                            <div class="col">
                                                <h3 class="m-b-0">GK-25547</h3><span>ID-Nr</span>
                                            </div>
                                            <div class="col">
                                                <h3 class="m-b-0">24548569895</h3><span>Passwort</span>
                                            </div>
                                          
                                        </div>
                                        <div class="mt-4">
											<a href="javascript:void()" class="btn btn-primary mb-1" data-toggle="modal" data-target="#sendMessageModal">Email</a>
											<a href="javascript:void()" class="btn btn-primary mb-1" data-toggle="modal" data-target="#sendSMSModal">SMS</a>
                                        </div>
                                    </div>
									<!-- Modal -->
														...
														<div class="row"> 
															...
															<div class="col-lg-12">
																<div class="form-group">
																	...
																	<textarea rows="8" class="form-control" name="comment" placeholder="Nachricht"></textarea>
																</div>
															</div>
															<div class="col-lg-12">
												...
												<div class="modal-body">
													<form class="comment-form">
														<div class="row"> 
															...
															<div class="col-lg-6">
																<div class="form-group">
																	<label class="text-black font-w600">HandyNummer <span class="required">*</span></label>
																	<input type="text" class="form-control" value="HandyNummer" placeholder="HandyNummer" name="HandyNummer">
																</div>
															</div>
															<div class="col-lg-12">
																<div class="form-group">
                                ...
                                <div class="profile-tab">
                                    <div class="custom-tab-1">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item"><a href="#about-me" data-toggle="tab" class="nav-link active show">Kunden Kartei</a>
                                            </li>
                                            <li class="nav-item"><a href="#profile-settings" data-toggle="tab" class="nav-link">Benachrichtigung</a>
                                            </li>
                                        </ul>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>Oliver Schnur </span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>01716820288</span>
                                                        </div>
                                                    </div>
												...
												<div class="profile-personal-info hoch">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>Investal24 </span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>GmbH</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>Bundesallee 217
															42103 Wuppertal</span>
                                                        </div>
                                                    </div>
													<div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>LU8333382</span>
                                                        </div>
                                                    </div>
