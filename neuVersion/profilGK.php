                      ...
                      <div id="about-me" class="tab-pane fade active show">
                        ...
                        <div class="profile-personal-info">
                          ...
                          <div class="row mb-2">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkVorname . ' ' . $gkNachname ?></span>
                            </div>
                          </div>
                          <div class="row mb-2">
                            <div class="col-sm-3 col-5">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkEmail ?></span>
                            </div>
                          </div>
                          <div class="row mb-2">
                            <div class="col-sm-3 col-5">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkTelefonnummer ?></span>
                            </div>
                          </div>
                        ...
                        <div class="profile-personal-info hoch">
                          ...
                          <div class="row mb-2">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkFirmenname ?></span>
                            </div>
                          </div>
                          <div class="row mb-2">
                            <div class="col-sm-3 col-5">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkRechtform ?></span>
                            </div>
                          </div>
                          <div class="row mb-2">
                            <div class="col-sm-3 col-5">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkAdresse . ', ' . $gkPlz . ' ' . $gkStadt ?></span>
                            </div>
                          </div>
                          <div class="row mb-2">
                            <div class="col-sm-3 col-5">
                            ...
                            <div class="col-sm-9 col-7"><span><?= $gkSteurnummer ?></span>
                            </div>
                          </div>
